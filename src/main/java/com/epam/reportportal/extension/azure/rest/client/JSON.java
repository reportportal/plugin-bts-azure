...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(IdentityBase.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("Identity".toUpperCase(), Identity.class);
                classByDiscriminatorValue.put("IdentityBase".toUpperCase(), IdentityBase.class);
                return getClassByDiscriminator(classByDiscriminatorValue, "Identity");
            }
          })
          .registerTypeSelector(TeamProjectReference.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
                classByDiscriminatorValue.put("TeamProject".toUpperCase(), TeamProject.class);
                classByDiscriminatorValue.put("TeamProjectReference".toUpperCase(), TeamProjectReference.class);
                return getClassByDiscriminator(classByDiscriminatorValue, "TeamProject");
            }
          })
          .registerTypeSelector(WebApiTeamRef.class, new TypeSelector() {
            @Override
            public Class getClassForElement(JsonElement readElement) {
                Map classByDiscriminatorValue = new HashMap();
